...
class _$TimeDAO extends TimeDAO {
  _$TimeDAO(this.database, this.changeListener)
      : _queryAdapter = QueryAdapter(database, changeListener),
        _timeInsertionAdapter = InsertionAdapter(
            database,
            'time',
  ...
  final InsertionAdapter<Time> _timeInsertionAdapter;
  ...
  Future<void> insertTime(Time time) async {
    await _timeInsertionAdapter.insert(time, OnConflictStrategy.abort);
  }
}
